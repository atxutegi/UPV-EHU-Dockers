...
cd maril-Model
#./bin/mbm_client --socket_type=udp --port=42042 --rtt=$latency --rate=$rateFinal --server=$host
...
ssh -o "StrictHostKeyChecking no" qospeter@158.227.68.19 "sh maril-in-monroe-TCPserver/testKiller.sh $1 $2 $3"
