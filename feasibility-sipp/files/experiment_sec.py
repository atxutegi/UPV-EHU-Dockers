...
if __name__ == '__main__':
    ...
    while (time.clock() - start_time_exp < exp_grace and
        ...
        #if not (check_if(ifname) and  #EHU NQAS
        #        check_modem_meta(meta_info)):  #EHU NQAS
        #    print "Interface went down during a experiment" #EHU NQAS
        #    if exp_process.is_alive():  #EHU NQAS
        #        exp_process.terminate()  #EHU NQAS
        #    if meta_process.is_alive():  #EHU NQAS
        #        meta_process.terminate()  #EHU NQAS
        #    sys.exit(1)  #EHU NQAS
