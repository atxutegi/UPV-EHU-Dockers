...
ssh -o "StrictHostKeyChecking no" eneko@130.243.26.13 "sudo sysctl -w net.ipv4.tcp_congestion_control=reno < /dev/null > /dev/null 2>&1"
...
ssh -o "StrictHostKeyChecking no" eneko@130.243.26.13 "sh wgetCCAsSlowStart/testKiller.sh $1 $2 RENO-$ite"
